...
ui <- fluidPage(
  ...
  fluidRow(column(width=8,plotOutput("Frequency")),
...
server <- function(input, output) {
  ...
  observeEvent(input$analyze, {
    analyzeClicked(TRUE)
    segments <- c(Baseline1 = input$Baseline1,Test_seg = input$Test_seg,Baseline2 = input$Baseline2)
  ...
  #Frequency output of whole data set
